...
return [
     ...
     */
    'landlord_database_connection_name' => env('landlord', 'landlord'),
    ...
    'database' => [
        'creation_parameters' => [
            // Set any parameters necessary for tenant database creation
        ],

        'migrations' => [
            'paths' => [
                // Add the paths where the tenant migrations are stored
